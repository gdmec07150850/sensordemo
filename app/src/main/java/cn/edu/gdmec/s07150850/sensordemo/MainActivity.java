package cn.edu.gdmec.s07150850.sensordemo;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAcceleroneter=mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
    ...
    protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(this,mAcceleroneter,SensorManager.SENSOR_DELAY_NORMAL);
